...
class Themify_Twitter extends WP_Widget {
	...
	function form( $instance ) {
		...
		<div class="twitter-username" style="display: <?php echo $instance['type'] === 'type-grid' ? 'none' : 'block' ?>">
			<p>
				<?php echo sprintf(__('<small>Twitter access token is required at <a href="%s">Themify > Settings > Twitter</a>.</small>', 'themify'), admin_url('admin.php?page=themify#setting-integration-api')); ?>
			</p>
