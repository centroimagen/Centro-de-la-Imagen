...
(function (exports, $) {
	...
	function parseJSON( data ) {
		...
		/* anything other than an object is not acceptable */
	...
	api.bind( 'pane-contents-reflowed', function() {
		...
		if( initialLoad ) {
			...
			const import_btn = $( '#customizer-importplupload-upload-ui' );
			if ( import_btn.data( 'init' ) !== 1 ) {
				themify_create_pluploader( import_btn );
			}
	...
	api.ThemifySubAccordion = api.Control.extend({
		ready() {
			...
			$navMenu.closest('label').each(function () {
