...
class TB_Menu_Module extends Themify_Builder_Component_Module {
	...
	public function get_options() {
		return array(
			...
			array(
				...
				'binding' => array(
					'slide' => array('show' => 'menu_slide_direction'),
					'overlay' => array('show' => 'menu_slide_direction'),
					'dropdown' => array('hide' =>'menu_slide_direction')
				),
				'wrap_class' => 'tb_checkbox_element_allow_menu'
			),
			array(
	...
	public function get_styling() {
		...
		$menu_mobile = array(
			...
			// current Menu Link
			self::get_expand(__('Current Menu Link', 'themify'), array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
