			 ...
			 <div class="builder-tabs-wrap tf_rel">
				...
				<# for(let i=0;i<arr.length;++i){#>
					<div data-id="tab-{{ tabId }}-{{ i }}" class="tab-content tf_overflow tf_clear" aria-hidden="{{i != 0}}">
						<div class="tb_text_wrap" contenteditable="false" data-name="text_tab" data-index="{{i}}" data-hasEditor data-repeat="tab_content_tab"><# arr[i]?.text_tab && print( arr[i].text_tab ) #></div>
					</div>
				<# } #>
			</div>
		</div>
