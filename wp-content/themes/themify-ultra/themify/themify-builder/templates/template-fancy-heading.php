...
$icon=$fields_args['icon_type']!=='image'?($fields_args['icon_type']!=='l'?($fields_args['icon']!=='' ? themify_get_icon($fields_args['icon']):'') : themify_get_lottie($fields_args, 'parent')):$fields_args['image'];
	...
	<?php if (!empty($icon)) : ?>
		<span class="tb_fancy_heading_icon_wrap <?php echo $is_inline === true ? 'tf_inline_b' : 'tf_block'; ?>">
			...
			<span class="tb_fancy_heading_icon">
				<?php if ($fields_args['icon_type'] !== 'image') : ?>
