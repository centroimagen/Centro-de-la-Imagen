...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_link_active_background' => array(
			...
			'selector' => '#main-nav-wrap #main-nav > .current_page_item > a, #main-nav-wrap #main-nav > .current-menu-item > a',
			'prop' => 'background',
		),
		...
		'main_nav_link_active_hover_background' => array(
			...
			'selector' => '#main-nav-wrap #main-nav > .current_page_item > a:hover, #main-nav-wrap #main-nav > .current-menu-item > a:hover',
			'prop' => 'background',
		),
		...
		'main_nav_dropdown_link_color' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, .fixed-header #main-nav ul a, #main-nav .has-mega-column > .sub-menu a, #main-nav .has-mega-sub-menu > .sub-menu a, .transparent-header #main-nav ul a',
			'prop' => 'color',
		),
		...
		'main_nav_link_dropdown_active_background' => array(
			...
			'selector' => '#main-nav-wrap #main-nav .sub-menu > .current_page_item > a, #main-nav-wrap #main-nav .sub-menu > .current-menu-item > a',
			'prop' => 'background',
		),
