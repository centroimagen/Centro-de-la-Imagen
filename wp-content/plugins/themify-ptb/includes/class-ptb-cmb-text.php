        ...
        <?php if ($args['repeatable']): ?>
            <div class="ptb_back_active_module_row">
                ...
                <div class="ptb_back_active_module_input ptb_back_text">
                    ...
                    <input type="radio" id="ptb_<?php echo $id ?>[br]"
                           name="[<?php echo $id ?>][display]" value="br"
                           <?php if (isset($data['display']) && $data['display'] == 'br'): ?>checked="checked"<?php endif; ?> />
                    <label for="ptb_<?php echo $id ?>[br]"><?php _e('Line Breaks', 'ptb') ?></label>
                </div>
            </div>
            <div class="ptb_back_active_module_row">	
                <div class="ptb_back_active_module_label">
                    <label for="ptb_<?php echo $id ?>_text_seperator"><?php _e('Separator', 'ptb') ?></label>
                </div>
