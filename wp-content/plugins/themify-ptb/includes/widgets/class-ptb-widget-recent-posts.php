...
class PTB_Widget_Recent_Posts extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __('Displays Post Type Builder Recent Posts.','ptb')
        );
        parent::__construct('ptb-recent-posts', __('PTB Posts','ptb'), $widget_ops);
    }
	...
	if(!is_array($instance)){
        ...
        <?php if (!empty($themplates)) { ?>
            ...
            <div class="ptb_recent_widget_wrapper ptb_widget_wrapper">
		...
		<?php
			...
			printf( __( 'Missing template. Please <a href="%s">add template</a>.', 'ptb' ), admin_url( 'admin.php?page=ptb-ptt' ) );
        } ?>
        <?php
    }
