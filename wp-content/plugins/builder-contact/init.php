...
class Builder_Contact {
    ...
    public static function admin_enqueue() {
        ...
        themify_enque_script('builder-contact-admin-scripts', self::$url . 'assets/admin.js',$ver, array('themify-builder-app-js'));
        wp_localize_script('builder-contact-admin-scripts', 'tb_contact_l10n', array(
            ...
            'types' => array(
                ...
                'date' => __('Date', 'builder-contact'),
            ),
			'date_picker_options' => [ '' => __( 'Date and Time Picker', 'builder-contact' ), 'date' => __( 'Only Date Picker', 'builder-contact' ), 'time' => __( 'Only Time Picker', 'builder-contact' ) ],
